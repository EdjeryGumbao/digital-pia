    ...
    <div class="row">
      <div class="col-lg-3 col-6">  
        ...
        <div class="small-box bg-success">
          ...
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="bi bi-check-circle" viewBox="-50 0 70 70">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-danger">
          ...
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="bi bi-x-circle" viewBox="-50 0 70 70">
              <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
          ...
          <div class="icon">
             <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="nav-icon bi-card-list" viewBox="-50 0 70 70">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
          ...
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="nav-icon bi-exclamation-triangle" viewBox="-50 0 70 70">
      ...
      <div class="col-md-6">
        <div class="card card-danger">
          <div class="card-header">
            <h3 class="card-title">PIA Reports</h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                      By continuing to browse this website, you agree to the University of Southeastern Philippines’ 
                      Data Privacy Statement. The full text of The Statement can be accessed through this 
                      <a href="http://www.usep.edu.ph/usep-data-privacy-statement/" class="text-primary text-decoration-none" target="_blank">link</a>.
                    </p>
                </div>
            </div>
        </div>

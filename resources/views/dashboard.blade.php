    ...
    <div class="row">
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
          ...
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-check-circle" viewBox="-44 0 60 60">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-danger">
          ...
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-x-circle" viewBox="-44 0 60 60">
              <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
          ...
          <div class="icon">
             <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="nav-icon bi-card-list" viewBox="-44 0 60 60">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
          ...
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="nav-icon bi-exclamation-triangle" viewBox="-44 0 60 60">

...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">     <!-- change this when you add users -->
        <div class="image">
          <img src="dist/img/user2-160x1601.jpg" class="img-circle elevation-2" alt="">
        </div>
        <div class="info">
          @if(auth()->check())
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @elseif (auth()->user()->usertype == 'user')
            <li class="nav-item">
              <a href="{{ url('') }}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="nav-icon bi-house-door-fill" viewBox="0 0 16 16">
          ...
          <li class="nav-item">
            <a href="{{ url('pialist') }}" class="nav-link">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="nav-icon bi-card-list" viewBox="0 0 16 16">
          ...
          @if (auth()->user()->usertype == 'admin')
            <li class="nav-item">
              <a href="{{ url('threatlist') }}" class="nav-link">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="nav-icon bi-exclamation-triangle" viewBox="0 0 16 16">
            ...
            <li class="nav-item">
              <a href="{{ url('manage') }}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="nav-icon bi-gear" viewBox="0 0 16 16">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="nav-icon bi-arrow-left-square" viewBox="0 0 16 16">
